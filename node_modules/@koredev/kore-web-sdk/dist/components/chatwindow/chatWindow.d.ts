...
declare class chatWindow extends EventEmitter {
    ...
    */
    ...
    updateScrollOnMessageRender(msgData: any): void;
    removeScrollingHide(): void;
    debounceScrollingHide(func: any, delay: any): () => void;
